...
//In the scope method, this is referring to the joe instance, so console.log(this) will output the details of the joe object, including its properties.
// 2. What is "this" when joe.scopeArrow() is invoked?
//Because scopeArrow is defined using an arrow function, this will not refer to the instance of Student (joe). Instead, it will be determined by the context in which scopeArrow was created.
